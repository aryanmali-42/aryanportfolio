...
`;
document.title = 'Aryan Mali';
let projects = [
  {
    image: 'textures/travelweb.png',
    url: 'https://easytravels.tech',
  },
  {
    image: 'textures/collegesup.png',
    url: 'https://github.com/aryanmali42/Examination.git',
  },
  {
    image: 'textures/teacherpyapp.png',
    url: 'https://github.com/aryanmali42/pyapp.git',
  },
  {
    image: 'textures/portfolio.png',
    url: 'https://eclectic-zabaione-8b2942.netlify.app/',
  },
];
let aboutCameraPos = {
  x: 0.12,
...
function loadIntroText() {
  ...
  loader.load('fonts/unione.json', function (font) {
    ...
    const titleGeo = new TextGeometry('  ARYAN MALI', {
      font: font,
      size: 0.08,
      height: 0.01,
    });
  ...
  loader.load('fonts/helvatica.json', function (font) {
    ...
    const subTitleGeo = new TextGeometry(
      'Web Developer / Programmer / Forex Trader / Content Creator',
      {
        font: font,
        size: 0.018,
        height: 0,
